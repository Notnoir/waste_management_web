...
<div class="container mx-auto mt-8 px-6">
    {{-- Flowbite Toast for Success Messages --}}
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-6">
        <img src="{{ $pengelola->profile_picture ? asset('storage/' . $pengelola->profile_picture) : 'https://via.placeholder.com/150' }}"
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-gray-800">{{ $pengelola->name }}</p>
            </div>

            <!-- Email -->
            <div>
                <p class="text-gray-600 font-medium">Email</p>
                <p class="text-gray-800">{{ $pengelola->email }}</p>
            </div>

            <!-- Phone -->
            <div>
                <p class="text-gray-600 font-medium">Nomor Telepon</p>
                <p class="text-gray-800">{{ $pengelola->phone_number ?? '-' }}</p>
            </div>

            <!-- Additional Fields (Optional) -->
            <div>
                <p class="text-gray-600 font-medium">Wilayah</p>
                <p class="text-gray-800">{{ $pengelola->region ? $pengelola->region->name : 'Belum dipilih' }}</p>
            </div>
