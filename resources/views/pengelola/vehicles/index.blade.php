...
<div class="p-6 space-y-4">
    ...
    <div class="flex flex-wrap justify-between items-center gap-4">
        <!-- Search Bar -->
        <form method="GET" action="{{ route('pengelola.vehicles.index') }}"
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-3 border-b text-center space-x-2">
                        <a href="{{ route('pengelola.vehicles.show', $vehicle->id) }}"
...
<div id="crud-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full overflow-y-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{ route('pengelola.vehicles.store') }}" method="POST" class="p-4 md:p-5">
                @csrf
...
<script>
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            editForm.action = `/pengelola/vehicles/${vehicleId}`;
