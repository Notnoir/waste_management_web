...
<div class="p-6 bg-gray-100">
    <h2 class="text-2xl font-semibold mb-6">Laporan Harian Pengelola</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white shadow rounded p-4">
            ...
            <p class="text-2xl font-bold text-yellow-600">{{ $pendingSchedules }}</p>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded p-4 mb-6">
        ...
        <p class="text-2xl font-bold text-blue-600">{{ $totalWasteVolume }} kg</p>
    </div>

    <!-- Sampah Berdasarkan Jenis -->
    <div class="bg-white shadow rounded p-4 mb-6">
        <h3 class="text-lg font-semibold">Volume Berdasarkan Jenis</h3>
        <ul>
    ...
    <div class="bg-white shadow rounded p-4 mb-6">
        ...
        <p class="text-2xl font-bold text-blue-600">{{ number_format($averageRating, 1) }}</p>
    </div>

    <!-- Total Transaksi -->
    <div class="bg-white shadow rounded p-4">
        <h3 class="text-lg font-semibold">Total Transaksi</h3>
        <p class="text-2xl font-bold text-blue-600">Rp {{ number_format($totalTransactions, 0, ',', '.') }}</p>
    </div>
</div>
@endsection